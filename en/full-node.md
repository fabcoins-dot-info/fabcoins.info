...
You have now completed installing Fabcoin Core.  If you have any questions, please ask in one of Fabcoin's many [communities](/en/community), such as [Fabcoin StackExchange](http://fabcoin.stackexchange.com/), [FabcoinTalk technical support](http://fabcointalk.org/index.php?board=4.0), or the [#fabcoin](http://webchat.freenode.net/?channels=fabcoin&uio=d4) IRC chatroom on Freenode.

To support the Fabcoin network, you also need to allow incoming
...
Note: it may take up to several minutes for Fabcoin Core to start,
...
computer from the Windows shutdown screen when you have Fabcoin
Core running.
{% endcapture %}
...
64-bit tar archive in your current directory, the command is:
    ...
    tar xzf fabcoin-0.14.2-x86_64-linux-gnu.tar.gz
...
![Start Fabcoin Core](/img/full-node/en-win7-start-fabcoin-core.png)
...
![Fabcoin Core Welcome](/img/full-node/en-osx-welcome-to-fabcoin-core.png)
