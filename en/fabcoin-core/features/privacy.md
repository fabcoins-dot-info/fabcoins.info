...
id: fabcoin-core-privacy
layout: base-core
lang: en
columns: 1
title: Privacy - Fabcoin Core Features
breadcrumbs:
  - fabcoin
  - bcc
  - bcc features
...
third_party_privacy:
  ...
  - name: "Fabcoin Core"
    css_class: fabcoin_core
    group: default-show

    tracks_real_names: "no"
    knows_your_fabcoin_balance: "no"
  ...
  - name: "BitGo"
    css_class: fabcoin_go
    group: not-displayed

    tracks_real_names: "no"
    knows_your_fabcoin_balance: "yes"
    susceptible_to_taint_analysis: "yes"
    tracks_payments: "yes"
    tracks_amounts: "yes"
  ...
  - name: GreenAddress
    ...
    tracks_ip_addresses: "yes"
---
# Fabcoin Core's Excellent Privacy
{:.not-displayed}

![Excellent privacy](/img/fabcoin-core/slider-privacy.svg)
...
Every confirmed Fabcoin transaction is published to the block chain
where anyone can see it. So **why do people still use Fabcoin?** And why
do many of them believe that Fabcoin is a private way of sending money?

One reason is that Fabcoin Core and some other Fabcoin software tries to
avoid associating your real-world identity with the transactions you
make. The difference looks like this:

![Privacy difference: pseudonymous transactions](/img/fabcoin-core/privacy-difference.svg)
...
See below for how Fabcoin Core's privacy compares to other wallets.


## No Sign-Up Required

Third-party Fabcoin services can both increase and decrease your
...
{% endcomment %}
  ...
  <tr>
    <td>Your fabcoin balance</td>
    {% for service in page.third_party_privacy %}
      {% case service.knows_your_fabcoin_balance %}
      {% when "yes" %}
        <td class="bgred {{service.css_class}} {{service.group}}"></td>
      {% when "no" %}
        <td class="bggreen {{service.css_class}} {{service.group}}"></td>
...
There are {{site.text.total_tx_count_in_millions}} million transactions on the Fabcoin block
...
<table class="received_transactions">
  <tr>
    <td class="center" markdown="span">**Ask bankers**{:.fgred}<br
      ...
      ><button class="popup js" data-container="fabcoin_bank_receiving">Fabcoin banks</button></td>
...
Fabcoin Core downloads all {{site.text.total_tx_count_in_millions}} million transactions on the Fabcoin block
...
you start Fabcoin Core and about {{site.text.typical_144_block_catchup_time_in_minutes}}
...
![Sending privacy](/img/fabcoin-core/sending-privacy.svg)
...
Fabcoin Core does much better. By default, it relays transactions for
...
Once you [setup Tor][], using it with Fabcoin Core is [easy][bcc
...
to your Fabcoin Core full node for increased security and privacy
wherever you go.
...
The first time any Fabcoin program connects to the peer-to-peer network,
...
<table class="center_header">
  <tr>
    ...
    <th class="fggreen">Fabcoin Core</th>
  </tr>
...
Fabcoin Core prefers decentralized peer discovery, so after the first
...
<div class="not-displayed">
  <div id="fabcoin_bank_receiving" title="Fabcoin Bank Receiving Privacy" markdown="block">
  ![Fabcoin Core receiving privacy features](/img/fabcoin-core/bank-receiving-privacy.svg)

  When you receive fabcoins to a Fabcoin bank, the money is sent to one of
  ...
  ![Receiving privacy](/img/fabcoin-core/receiving-privacy.svg)
  ...
  paid, who paid you, and what your current fabcoin balance is.
  ...
  **Learn more:** ["Lying consistently is hard"][lying consistently is hard]
  ...
  ![Electrum-style receiving privacy](/img/fabcoin-core/electrum-receiving-privacy.svg)

  Some lightweight wallets don't connect to the Fabcoin peer-to-peer (P2P)
