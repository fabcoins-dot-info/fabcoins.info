...
## Required title.
title: Fabcoin Core version 0.10.3 released
...
Fabcoin Core version 0.10.3 is now available from:

  <http://fabcoins.info/bin/fabcoin-core-0.10.3/>
...
(see <http://github.com/blockchaingate/fabcoin/pull/6793>, as well as the 0.11.0
