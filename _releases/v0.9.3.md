...
title: Fabcoin Core version 0.9.3 released
---
Fabcoin Core version 0.9.3 is now available from:

  <http://fabcoins.info/bin/0.9.3/>
...
- Upgrade OpenSSL to 1.0.1i (see <http://www.openssl.org/news/secadv_20140806.txt> - just to be sure, no critical issues for Fabcoin Core)
