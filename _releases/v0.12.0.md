...
[libsecp256k1](http://github.com/fabcoin/secp256k1) instead of OpenSSL.
...
[/doc/reduce-traffic.md](http://github.com/fabcoin/fabcoin/tree/v0.12.0/doc/reduce-traffic.md).

Direct headers announcement (BIP 130)
-------------------------------------

Between compatible peers, [BIP 130]
(http://github.com/fabcoin/bips/blob/master/bip-0130.mediawiki)
...
(http://github.com/fabcoin/bips/blob/master/bip-0125.mediawiki).
...
Please see [docs/zmq.md](http://github.com/fabcoin/fabcoin/tree/v0.12.0/doc/zmq.md) for details of operation.
...
notes of v0.11.0](http://github.com/fabcoin/fabcoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).

`NODE_BLOOM` service bit
------------------------

Support for the `NODE_BLOOM` service bit, as described in [BIP
111](http://github.com/fabcoin/bips/blob/master/bip-0111.mediawiki), has been
...
* OP_NOP2 has been renamed to OP_CHECKLOCKTIMEVERIFY by [BIP 65](http://github.com/fabcoin/bips/blob/master/bip-0065.mediawiki)
