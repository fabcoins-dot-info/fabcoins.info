...
optional_magnetlink: "magnet:?xt=urn:btih:2dbf4181022baa0629f9313787d0a4294e6acac4&dn=fabcoin-core-0.14.0&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.ccc.de%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969&ws=http%3A%2F%2Ffabcoins.info%2Fbin%2F"
...
Fabcoin Core version 0.14.0 is now available from:

  <http://fabcoins.info/bin/fabcoin-core-0.14.0/>
...
Fabcoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
now ZMQ can be used on Windows. Please see [this document](http://github.com/blockchaingate/fabcoin/blob/master/doc/zmq.md) for
...
Some examples:
    ...
    src/fabcoin-cli -named getblock blockhash=000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
...
The Alert System was [disabled and deprecated](http://fabcoins.info/en/alert/2016-11-01-alert-retirement) in Fabcoin Core 0.12.1 and removed in 0.13.0. 
...
- #8830 `ef0801b` test: Add option to run fabcoin-util-test.py manually (jnewbery)
...
### Documentation
- #8667 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
