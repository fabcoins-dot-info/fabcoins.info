...
title: Fabcoin Core version 0.9.2.1 released
---
Fabcoin Core version 0.9.2.1 is now available from:

  <http://fabcoins.info/bin/0.9.2.1/>
...
- Lower paytxfee warning threshold from 0.25 FAB to 0.01 FAB
...
- Fix "Start fabcoin on system login"
