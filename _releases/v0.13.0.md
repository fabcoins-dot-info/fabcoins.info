...
## Required title.
title: Fabcoin Core version 0.13.0 released
...
optional_magnetlink: "magnet:?xt=urn:btih:35367ed2db6c41f7af9c1ed2dd54ae29d99bc632&dn=fabcoin-core-0.13.0&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.ccc.de%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969&ws=http%3A%2F%2Ffabcoins.info%2Fbin%2F"
...
Fabcoin Core version 0.13.0 is now available from:

  <http://fabcoins.info/bin/fabcoin-core-0.13.0/>
...
updates will be released anymore. Without security updates, using a fabcoin
wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of Fabcoin Core
randomly crashing on Windows XP. It is [not clear](http://github.com/blockchaingate/fabcoin/issues/7681#issuecomment-217439891)
...
- Adding `dbcache=100` in fabcoin.conf
...
For example:
    ...
    $ src/fabcoin-cli -stdin walletpassphrase
    mysecretcode
    120
...
Various code modernizations have been done. The Fabcoin Core code base has
...
- `fabcoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries for the most
  common 32-bit ARM architecture.
- `fabcoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries for the most
...
compatible peers.
[BIP 152](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0152.mediawiki)
...
HD wallets are incompatible with older versions of Fabcoin Core.

[Pull request](http://github.com/blockchaingate/fabcoin/pull/8035/files), [BIP 32](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0032.mediawiki)
...
141](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of Fabcoin Core is expected that
...
Witness)] (http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0141.mediawiki).
...
(http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
The two phases are distinct in the Fabcoin-Qt GUI. During the first one,
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0133.mediawiki)
...
65](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](http://github.com/blockchaingate/fabcoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR #[7762](http://github.com/blockchaingate/fabcoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for fabcoin-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use FAB/kB (MarcoFalke)
...
- #7613 `3798e5d` Add autocomplete to fabcoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add fabcoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: fabcoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from fabcoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the Fabcoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for fabcoind procs (MarcoFalke)
...
- #8164 `0f24eaf` [Fabcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of fabcoind startup (laanwj)
...
- #7975 `fc23fee` Update fabcoin-core GitHub links (MarcoFalke)
