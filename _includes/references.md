...
[label]: /en/developer-guide#term-label "The label parameter of a fabcoin: URI which provides the spender with the receiver's name (unauthenticated)"
...
[message]: /en/developer-guide#term-message "A parameter of fabcoin: URIs which allows the receiver to optionally specify a message to the spender"
...
[network]: /en/developer-guide#term-network "The Fabcoin P2P network which broadcasts transactions and blocks"
...
[PKI]: /en/developer-examples#term-pki "Public Key Infrastructure; usually meant to indicate the X.509 certificate system used for HTTP Secure (http)."
...
[proper money handling]: /en/developer-reference#term-proper-money-handling "Fabcoin amounts need to be correctly processed without introducing rounding errors that could cause monetary loss"
[r]: /en/developer-guide#term-r-parameter "The payment request parameter in a fabcoin: URI"
...
[URI QR Code]: /en/developer-guide#term-uri-qr-code "A QR code containing a fabcoin: URI"
[v2 block]: /en/developer-reference#term-v2-block "The current version of Fabcoin blocks"
[verified payments]: /en/developer-guide#verifying-payment "Payments which the receiver believes won't be double spent"
[wallet support]: /en/developer-reference#term-wallet-support "A Fabcoin Core ./configure option that enables (default) or disables the wallet"
...
[bcc contribute]: /en/fabcoin-core/contribute/
[bcc contribute code]: /{{page.lang}}/{% translate development url %}
[bcc contribute documentation]: /en/fabcoin-core/contribute/documentation
[bcc contribute issues]: /en/fabcoin-core/contribute/issues
[bcc contribute support]: /en/fabcoin-core/contribute/support
[bcc contribute translations]: /en/fabcoin-core/contribute/translations
[bcc decentralized peer discovery]: /en/fabcoin-core/features/privacy#decentralized-peer-discovery
[bcc documentation]: /en/fabcoin-core/help#documentation
[bcc download]: /en/download
[bcc features]: /en/fabcoin-core/features/
[bcc forums]: /en/fabcoin-core/help#forums
[bcc help]: /en/fabcoin-core/help
[bcc live help]: /en/fabcoin-core/help#live
[bcc main]: /en/fabcoin-core/
[bcc network support]: /en/fabcoin-core/features/network-support
[bcc privacy]: /en/fabcoin-core/features/privacy
[bcc privacy data leaking]: /en/fabcoin-core/features/privacy#perfect-privacy-for-received-transactions
[bcc requirements]: /en/fabcoin-core/features/requirements
[bcc user interface]: /en/fabcoin-core/features/user-interface
[bcc user interface lightweight]: /en/fabcoin-core/features/user-interface#lightweight
[bcc validation]: /en/fabcoin-core/features/validation
[bcc validation decentralization]: /en/fabcoin-core/features/validation#help-protect-decentralization
[bcc validation do you validate]: /en/fabcoin-core/features/validation#do-you-validate
[bcc validation protection]: /en/fabcoin-core/features/validation#how-validation-protects-your-fabcoins
[bcc version history]: /en/version-history

[Fabcoin Core 0.6.0]: /en/release/v0.6.0
[Fabcoin Core 0.6.1]: /en/release/v0.6.1
[Fabcoin Core 0.7.0]: /en/release/v0.7.0
[Fabcoin Core 0.8.0]: /en/release/v0.8.0
[Fabcoin Core 0.9.0]: /en/release/v0.9.0
[Fabcoin Core 0.9.1]: /en/release/v0.9.1
[Fabcoin Core 0.9.2]: /en/release/v0.9.2
[Fabcoin Core 0.9.3]: /en/release/v0.9.3
[Fabcoin Core 0.10.0]: /en/release/v0.10.0
[Fabcoin Core 0.10.1]: /en/release/v0.10.1
[Fabcoin Core 0.10.2]: /en/release/v0.10.2
[Fabcoin Core 0.10.3]: /en/release/v0.10.3
[Fabcoin Core 0.11.0]: /en/release/v0.11.0
[Fabcoin Core 0.11.1]: /en/release/v0.11.1
[Fabcoin Core 0.11.2]: /en/release/v0.11.2
[Fabcoin Core 0.12.0]: /en/release/v0.12.0
[Fabcoin Core 0.12.1]: /en/release/v0.12.1
[Fabcoin Core 0.13.0]: /en/release/v0.13.0
[Fabcoin Core 0.13.1]: /en/release/v0.13.1
[Fabcoin Core 0.13.2]: /en/release/v0.13.2
[Fabcoin Core 0.14.0]: /en/release/v0.14.0
[Fabcoin Core 0.14.1]: /en/release/v0.14.1
[Fabcoin Core 0.14.2]: /en/release/v0.14.2
[fabcoin URI subsection]: /en/developer-guide#fabcoin-uri
[fabcoind initial setup]: /en/developer-examples
[fabcoinpdf]: http://fabcoins.info/en/fabcoin-paper
...
[#fabcoin]: http://webchat.freenode.net/?channels=fabcoin&uio=d4
...
[Fabcoin Seeder]: http://github.com/sipa/fabcoin-seeder
[Fabcoin stackexchange]: http://fabcoin.stackexchange.com
[Fabcoin stackexchange tag fabcoin-qt]: http://fabcoin.stackexchange.com/questions/tagged/fabcoin-qt
[fabcoin-documentation mailing list]: http://groups.google.com/forum/#!forum/fabcoin-documentation
...
[MIME]: http://en.wikipedia.org/wiki/Internet_media_type
