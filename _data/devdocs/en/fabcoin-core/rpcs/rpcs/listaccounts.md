...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/listaccounts.md" %}
...
{{WARNING}} `listaccounts` will be removed in a later version of Fabcoin
...
- n: "→<br>Account : Balance"
  t: "string : number (fabcoins)"
  p: "Required<br>(1 or more)"
  d: "The name of an account as a string paired with the balance of the account as a number of fabcoins.  The number of fabcoins may be negative if the account has spent more fabcoins than it received.  Accounts with zero balances and zero transactions will be displayed"
...
{% highlight bash %}
fabcoin-cli -testnet listaccounts 1 true
{% endhighlight %}
