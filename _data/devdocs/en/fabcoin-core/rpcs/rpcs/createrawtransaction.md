...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/createrawtransaction.md" %}
...
- n: "→<br>Address/Amount"
  ...
  p: "Required<br>(1 or more)"
  d: "A key/value pair with the address to pay as a string (key) and the amount to pay that address (value) in fabcoins"
...
- n: "Locktime"
  t: "numeric (int)"
  p: "Optional<br>(0 or 1)"
  d: "*Added in Fabcoin Core 0.12.0*<br><br>Indicates the earliest time a transaction can be added to the block chain"
