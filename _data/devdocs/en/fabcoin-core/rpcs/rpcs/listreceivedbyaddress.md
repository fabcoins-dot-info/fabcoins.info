...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/listreceivedbyaddress.md" %}
...
- n: "→ →<br>`account`"
  t: "string"
  p: "Required<br>(exactly 1)"
  d: "*Deprecated: will be removed in a later version of Fabcoin Core*<br><br>The account the address belongs to.  May be the default account, an empty string (\"\")"

- n: "→ →<br>`amount`"
  t: "number (fabcoins)"
  p: "Required<br>(exactly 1)"
  d: "The total amount the address has received in fabcoins"
...
{% highlight bash %}
fabcoin-cli -testnet listreceivedbyaddress 6 false true
{% endhighlight %}
