...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/getaddressesbyaccount.md" %}
...
{{WARNING}} `getaddressesbyaccount` will be removed in a later version of Fabcoin
...
{% highlight bash %}
fabcoin-cli -testnet getaddressesbyaccount "doc test"
{% endhighlight %}
