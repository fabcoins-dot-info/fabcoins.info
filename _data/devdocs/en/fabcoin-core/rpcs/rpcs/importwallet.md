...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/importwallet.md" %}
...
- n: "Filename"
  ...
  d: "The file to import.  The path is relative to Fabcoin Core's working directory"
...
{% highlight bash %}
fabcoin-cli -testnet importwallet /tmp/dump.txt
{% endhighlight %}
