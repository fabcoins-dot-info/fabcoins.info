...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/lockunspent.md" %}
...
{% highlight bash %}
fabcoin-cli -testnet lockunspent false '''
  [
    {
...
{% highlight bash %}
fabcoin-cli -testnet listlockunspent
{% endhighlight %}
...
{% highlight bash %}
fabcoin-cli -testnet lockunspent true '''
[
  {
    "txid": "5a7d24cd665108c66b2d56146f244932edae4e2376b561b3d396d5ae017b9589",
    "vout": 0
