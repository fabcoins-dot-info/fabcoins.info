...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/submitblock.md" %}
...
- n: "Parameters"
  ...
  d: "A JSON object containing extra parameters.  Not used directly by Fabcoin Core and also not broadcast to the network.  This is available for use by mining pools and other software.  A common parameter is a `workid` string"
...
{% highlight bash %}
fabcoin-cli -testnet submitblock 02000000df11c014a8d798395b5059c\
