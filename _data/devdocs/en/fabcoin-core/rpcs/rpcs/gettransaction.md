...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/gettransaction.md" %}
...
- n: "→<br>`amount`"
  t: "number (fabcoins)"
  p: "Required<br>(exactly 1)"
  d: "A positive number of fabcoins if this transaction increased the total wallet balance; a negative number of fabcoins if this transaction decreased the total wallet balance, or `0` if the transaction had no net effect on wallet balance"

- n: "→<br>`fee`"
  t: "number (fabcoins)"
  p: "Optional<br>(0 or 1)"
  d: "If an outgoing transaction, this is the fee paid by the transaction reported as negative fabcoins"
...
{% highlight bash %}
fabcoin-cli -testnet gettransaction \
