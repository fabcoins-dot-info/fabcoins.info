...
{{WARNING}} `estimatepriority` has been [removed](http://github.com/blockchaingate/fabcoin/commit/fe282acd7604b5265762b24e531bdf1ebb1f009b) and will no longer be available in the next major release (planned for Fabcoin Core 0.15.0).  Use the RPC listed in the "See Also" subsection below instead.
