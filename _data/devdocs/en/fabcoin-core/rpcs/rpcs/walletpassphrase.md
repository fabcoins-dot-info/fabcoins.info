...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/walletpassphrase.md" %}
...
Unlock the wallet for 75 seconds (the passphrase is "test"):

{% highlight bash %}
fabcoin-cli -testnet walletpassphrase test 600
{% endhighlight %}
