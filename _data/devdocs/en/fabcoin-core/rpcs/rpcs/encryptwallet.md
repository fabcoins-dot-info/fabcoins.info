...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/encryptwallet.md" %}
...
{% highlight bash %}
fabcoin-cli -testnet encryptwallet "test"
{% endhighlight %}

Result:

{% highlight text %}
wallet encrypted; Fabcoin server stopping, restart to run with encrypted
