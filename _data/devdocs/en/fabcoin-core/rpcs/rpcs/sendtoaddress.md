...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/sendtoaddress.md" %}
...
- n: "Amount"
  t: "number (fabcoins)"
  p: "Required<br>(exactly 1)"
  d: "The amount to spent in fabcoins"
...
- n: "Subtract Fee From Amount"
  t: "boolean"
  p: "Optional<br>(0 or 1)"
  d: "The fee will be deducted from the amount being sent. The recipient will receive less fabcoins than you enter in the amount field. Default is `false`"
...
Spend 0.1 fabcoins to the address below with the comment "sendtoaddress
example" and the comment-to "Nemo From Example.com":

{% highlight bash %}
fabcoin-cli -testnet sendtoaddress mmXgiR6KAhZCyQ8ndr2BCfEq1wNG2UnyG6 \
