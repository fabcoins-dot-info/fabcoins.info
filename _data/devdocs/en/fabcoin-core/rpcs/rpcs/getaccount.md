...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/rpcs/rpcs/getaccount.md" %}
...
- n: "Address"
  ...
  d: "A P2PKH or P2SH Fabcoin address belonging either to a specific account or the default account (\"\")"
...
{% highlight bash %}
fabcoin-cli -testnet getaccount mjSk1Ny9spzU2fouzYgLqGUD8U41iR35QN
{% endhighlight %}
