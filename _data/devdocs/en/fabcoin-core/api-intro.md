...
{% endcomment %}
{% assign filename="_data/devdocs/en/fabcoin-core/api-intro.md" %}
...
Fabcoin Core RPCs accept and return the byte-wise reverse of computed
...
However, Fabcoin Core's RPCs use the byte-wise reverse for hashes, so if you
...
Fabcoin Core's use of hashes (which are byte arrays in C++) as integers
...
other Fabcoin software, this reversal of hashes has become the standard
