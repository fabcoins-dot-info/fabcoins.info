...
{% comment %}
// Used on en/fabcoin-core/privacy to show/hide columns based on button
// clicks
{% endcomment %}
$('.showcolumn').each(function() {
  $(this).on('click', function() {
    var class_name = $(this).attr('id');
    if (class_name === 'fabcoin_core') return;
    $('.showcolumn').toggleClass('active', false);
    $('.showcolumn#fabcoin_core, .showcolumn#' + class_name).toggleClass('active', true);
    $('.privacy-comparison th, .privacy-comparison td').toggle(false);
    $('.privacy-comparison td:first-child, .privacy-comparison th:first-child, .privacy-comparison .fabcoin_core').toggle(true);
    $('.privacy-comparison .' + class_name).toggle('highlight', 750);
  });
});

{% comment %}
// Used on en/fabcoin-core/features/validation to create an accordion-style
...
{% comment %}
// Used on the en/fabcoin-core/features/user-interface page to show wallets
// that support dedicated connections to Fabcoin Core.
{% endcomment %}
$(function() {
...
{% comment %}// Used on fabcoin-core/feature/requirements{% endcomment %}
$(function() {
...
{% comment %}
// Begin: slideshow JS, used on en/fabcoin-core/features/
